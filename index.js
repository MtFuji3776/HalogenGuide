...
(function($PS) {
  // Generated by purs version 0.14.3
  "use strict";
  $PS["HandleKey"] = $PS["HandleKey"] || {};
  var exports = $PS["HandleKey"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Data_Array = $PS["Data.Array"];
  ...
  var render = function (state) {
      var f = function (xs) {
          return Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text(xs) ]);
      };
      return Halogen_HTML_Elements.div_(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Hold down the shift key and type some characters!") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Press ENTER or RETURN to clear and remove the event listener.") ]) ])(Data_Functor.map(Data_Functor.functorArray)(f)(state.strarr)));
  };
      ...
      return function (v) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Window.document)(Web_HTML.window)))(function (document) {
                  return Halogen_Query_HalogenM["subscribe'"](function (sid) {
                      return Halogen_Query_Event.eventListener(Web_UIEvent_KeyboardEvent_EventTypes.keydown)(Web_HTML_HTMLDocument.toEventTarget(document))((function () {
                          var $26 = Data_Functor.map(Data_Maybe.functorMaybe)(HandleKey.create(sid));
                          return function ($27) {
                              return $26(Web_UIEvent_KeyboardEvent.fromEvent($27));
                          };
                      })());
                  });
              });
          ...
          if (v instanceof HandleKey) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value1))))(function () {
                  ...
                  return Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)((function () {
                      var x = Data_String_CodePoints.length($$char);
                      return Data_Array.foldr(Data_HeytingAlgebra.disj(Data_HeytingAlgebra.heytingAlgebraBoolean))(false)(Data_Array.zipWith(Data_Eq.eq(Data_Eq.eqInt))(Data_Array.replicate(10)(x))([ 0, 1, 2, 3, 4, 5 ]));
                  })())(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                      var $10 = $$char === "Enter";
                      if ($10) {
                          var $11 = {};
                          for (var $12 in st) {
                          ...
                          $11.chars = st.chars + "\x0a";
                          $11.strarr = Data_Semigroup.append(Data_Semigroup.semigroupArray)(st.strarr)([ st.chars ]);
                          return $11;
                      };
                      var $14 = $$char === "Tab";
                      if ($14) {
                      ...
                      $18.chars = st.chars + $$char;
                      return $18;
                  }));
              });
          };
          throw new Error("Failed pattern match at HandleKey (line 63, column 16 - line 84, column 33): " + [ v.constructor.name ]);
      };
  };
  ...
  var mainHandleKey = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Halogen_VDom_Driver.runUI(component(Effect_Aff_Class.monadAffAff))(Data_Unit.unit)(body);
  }));
  exports["mainHandleKey"] = mainHandleKey;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.3
  "use strict";
  ...
  var render = function (state) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Hold down the shift key and type some characters!") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Press ENTER or RETURN to clear and remove the event listener.") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text(state.chars) ]) ]);
  };
  var main = HandleKey_1.mainHandleKey;
  var initialState = function (v) {
      return {
          chars: ""
      };
      ...
      return function (v) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Window.document)(Web_HTML.window)))(function (document) {
                  return Halogen_Query_HalogenM["subscribe'"](function (sid) {
                      return Halogen_Query_Event.eventListener(Web_UIEvent_KeyboardEvent_EventTypes.keyup)(Web_HTML_HTMLDocument.toEventTarget(document))((function () {
                          var $16 = Data_Functor.map(Data_Maybe.functorMaybe)(HandleKey.create(sid));
                          return function ($17) {
                              return $16(Web_UIEvent_KeyboardEvent.fromEvent($17));
                          };
                      })());
                  });
              });
          ...
          if (v instanceof HandleKey) {
              if (Web_UIEvent_KeyboardEvent.shiftKey(v.value1)) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value1))))(function () {
                      var $$char = Web_UIEvent_KeyboardEvent.key(v.value1);
                      return Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Data_String_CodePoints.length($$char) === 1)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          var $8 = {};
                          for (var $9 in st) {
                          ...
                          $8.chars = st.chars + $$char;
                          return $8;
                      }));
                  });
              };
              if (Web_UIEvent_KeyboardEvent.key(v.value1) === "Enter") {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value1))))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          return Halogen_Query_HalogenM.unsubscribe(v.value0);
                      });
                  });
              };
              if (Data_Boolean.otherwise) {
          ...
          throw new Error("Failed pattern match at Main (line 59, column 16 - line 81, column 18): " + [ v.constructor.name ]);
      };
  };
  var component = function (dictMonadAff) {
      return Halogen_Component.mkComponent({
