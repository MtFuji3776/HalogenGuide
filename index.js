...
(function($PS) {
  ...
  var button = (function () {
      var render = function (v) {
          return Halogen_HTML_Elements.button_([ Halogen_HTML_Core.text(v.label) ]);
      };
  ...
  var parent = function (dictMonadAff) {
      var render = function (v) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML.slot_()(new Data_Symbol.IsSymbol(function () {
              return "button";
          }))(Data_Ord.ordUnit)(_button)(Data_Unit.unit)(button)({
              label: Data_Show.show(Data_Show.showInt)(v.count)
          }) ]);
      };
      var initialState = function (v) {
          return {
      ...
      var handleAction = function (v) {
          if (v instanceof Initialize) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Halogen_Subscription.create))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.subscribe(v1.emitter)))(function () {
                      return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Effect_Aff.forkAff(Control_Monad_Rec_Class.forever(Effect_Aff.monadRecAff)(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Aff.delay(1000.0))(function () {
                          return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Halogen_Subscription.notify(v1.listener)(Increment.value));
                      })))));
                  });
              });
          };
          if (v instanceof Increment) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  ...
                  $27.count = st.count + 1 | 0;
                  return $27;
              });
          };
          throw new Error("Failed pattern match at Parent (line 54, column 24 - line 64, column 67): " + [ v.constructor.name ]);
      };
      return Halogen_Component.mkComponent({
          initialState: initialState,
          render: render,
  ...
  var mainParent = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Halogen_VDom_Driver.runUI(parent(Effect_Aff_Class.monadAffAff))(Data_Unit.unit)(body);
  }));
  exports["mainParent"] = mainParent;
})(PS);
(function(exports) {
  "use strict";
...
(function($PS) {
  ...
  var handleAction = function (dictMonadAff) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Main (line 60, column 16 - line 82, column 18): " + [ v.constructor.name ]);
      };
  };
